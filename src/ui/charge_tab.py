...
from PySide6.QtCore import QRectF, QSettings, QSize, QThread, Qt
...
class ChargeTab(QWidget):
    ...
    def _run_statistics(self) -> None:
        ...
        self._dispatch_statistics_task(
            ...
            task=process_charge_statistics,
    ...
    def _run_merge(self) -> None:
        ...
        self._dispatch_statistics_task(
            action="合并后统计数据",
            output_dir=mode_output_dir,
            total_items=self._count_merge_items(inputs),
            task=process_charge_merge,
            task_args=(inputs, mode_output_dir),
            chunk_size=chunk_size,
            wait_seconds=wait_seconds,
        )
